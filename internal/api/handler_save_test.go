...
func saveURL(score int64, displayName, jwt, sigOverride string) string {
	body, err := savedata.Marshal(&savedata.Data{Score: score})
	if err != nil {
		panic(err)
	}
	q := url.Values{}
...
func TestSave_Ranked(t *testing.T) {
	...
	rr, body := get(t, h, saveURL(1234, "alice", "any.jwt.value", ""))
...
func TestSave_MissingJWT_Rejected(t *testing.T) {
	...
	rr, _ := get(t, h, saveURL(100, "alice", "", ""))
...
func TestSave_InvalidJWT_Rejected(t *testing.T) {
	...
	rr, _ := get(t, h, saveURL(1, "alice", "tok", ""))
...
func TestSave_BlacklistedJWT_Rejected(t *testing.T) {
	...
	rr, body := get(t, h, saveURL(100, "alice", "any.jwt.value", ""))
...
func TestSave_RejectsBadHMAC(t *testing.T) {
	...
	rr, body := get(t, h, saveURL(100, "alice", "any.jwt.value", "deadbeef"))
...
func TestSave_DisplayNameMismatch_Rejected(t *testing.T) {
	...
	rr, body := get(t, h, saveURL(100, "bob", "any.jwt.value", ""))
